<%@ Page Title="" Language="C#" MasterPageFile="~/design/MasterPage.master" AutoEventWireup="true"
    CodeFile="PayBill.aspx.cs" Inherits="PayBill" %>
...
<div class="art-Post">
    ...
    <br />
    <br />
    <asp:Label ID="lblTeacherName" runat="server" Style="font-size: small"></asp:Label>
    ,
    <asp:Label ID="lblDesignation" runat="server" Style="font-size: small"></asp:Label>
    &nbsp;
    </div>
            <div class="cleared">
            </div>
...
<div class="art-Post">
    ...
    <div id="bodyDiv" style="background-color: #E2E9E3">
        ...
        <br />
        <asp:Wizard ID="WizardBillSteps" runat="server" ActiveStepIndex="1" OnNextButtonClick="WizardBillSteps_NextButtonClick"
