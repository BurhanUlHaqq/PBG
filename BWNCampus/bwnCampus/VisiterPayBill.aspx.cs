...
public partial class PayBill : System.Web.UI.Page
{
    ...
    protected void btnAccountNoSave_Click(object sender, EventArgs e)
    {
        ...
        if (MainNode.ChildNodes.Count == 0 || match == 0)
        {
            ...
            TeacherElement.SetAttribute("Designation", "Visitor");
        ...
        {
            XmlNode TeacherEleme = doc.SelectSingleNode("IUBFacultyPaymentBills/Teacher[@Name='" + ddlTeacherName.SelectedItem.Text + "']");
    ...
    protected void CaledarDate_DayRender(object sender, DayRenderEventArgs e)
    {
        ...
        if (File.Exists(path + smsterName + "_" + year + ".xml"))
        {
            XmlDocument doc = new XmlDocument();
            doc.Load(path + smsterName + "_" + year + ".xml");
            XmlNode selectedTeacher = doc.SelectSingleNode("IUBFacultyPaymentBills/Teacher[@Name='" + ddlTeacherName.SelectedItem.Text + "']");
    ...
    private void addAttandenceToXMLFile()
    {
        ...
        if (File.Exists(path + smsterName + "_" + year + ".xml"))
        {
            ...
            if (monthNode == null)
            {
                ...
                MonthElement.SetAttribute("TotalLectureDelivered", "");
                MonthElement.SetAttribute("TotalAmount", "");
                MonthElement.SetAttribute("IncomeTex", "");
                MonthElement.SetAttribute("NetAmountPayable", "");
    ...
    protected void WizardBillSteps_FinishButtonClick(object sender, WizardNavigationEventArgs e)
    {
        ...
        Session["PaymentBill"] = lblDepartmentName.Text + ":Visiting:" + smsterName + ":" + ddlYear.SelectedItem.Text + ":" + ddlTeacherName.SelectedItem .Text + ":Lecturer";
